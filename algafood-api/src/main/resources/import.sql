...
insert into cozinha (id, nome) values (5, 'Australiana');
insert into cozinha (id, nome) values (6, 'Chinesa');
...
insert into cidade (id, nome, estado_id) values (7, 'Niterói', 4);
...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (7, 'Pizzaria Parmê', 16.50, 3, utc_timestamp, utc_timestamp);
